...
export interface EcoTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "governanceWeight",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface EcoToken extends BaseContract {
  ...
  governanceWeight: TypedContractMethod<[user: AddressLike], [bigint], "view">;
  ...
  stakes: TypedContractMethod<
    [arg0: AddressLike],
    [[bigint, bigint] & { amount: bigint; since: bigint }],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "governanceWeight"
